...
*************************************************************************/
const char *CUSTOM_CT_HPLMN[] = {"46011F", "46003F", CUSTOM_PLMN_SET_END};
const char *CUSTOM_VZW_HPLMN[] = {"311480", CUSTOM_PLMN_SET_END};
/*****************************************************************************
* FUNCTION
...
const char *CUSTOM_NWSEL_EHPLMN_LIST[][CUSTOM_NWSEL_EHPLMN_MAX_NUM] = {
                                        {"46011F","46003F","45507F"}
                                        };
/* How many sets */
const kal_uint32 CUSTOM_NWSEL_EHPLMN_SET = sizeof(CUSTOM_NWSEL_EHPLMN_LIST)/(sizeof(char *)*CUSTOM_NWSEL_EHPLMN_MAX_NUM);
/*****************************************************************************
