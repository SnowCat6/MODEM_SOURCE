 ...
 */
    #define GLOBAL_MEM_SIZE                     (1530364 + 72884)
    #define GLOBAL_DEBUG_MEM_SIZE               (201884)
    #define GLOBAL_HISR_SHARED_IRAM_STACK_SIZE  (8192)
    #define GLOBAL_TOTAL_CREATED_TASK_NUMBER    (62)
#endif  
