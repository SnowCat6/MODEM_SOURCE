...
TRC_MSG(RAC_GET_LAST_STATE_STATUS_INFO,"[RAC] LAST gsm_state:%Mreg_state_enum,gsm_status:%Ml4c_rac_response_enum,gprs_state:%Mreg_state_enum,gprs_status:%Ml4c_rac_gprs_status_enum,is_on_hplmn:%Mkal_bool")
TRC_MSG(RAC_GET_CURRENT_STATE_STATUS_INFO,"[RAC] CURRENT gsm_state:%Mreg_state_enum,gsm_status:%Ml4c_rac_response_enum,gprs_state:%Mreg_state_enum,gprs_status:%Ml4c_rac_gprs_status_enum,is_on_hplmn:%Mkal_bool")
...
TRC_MSG(RAC_TRC_WAITING_FOR_SAT_RSP, "[RAC] Waiting for SAT to respond for previous SAT LOCATION INFO")
#endif /* __SAT_LOWCOST_NW_DISABLE__ */
#endif /* __SAT__ */

TRC_MSG(RAC_CHECK_NOT_TO_SEND, "[RAC] Display optimization. %s skip this reg_ind")

/*--------------------TRACE_ERROR Class--------------------*/
TRC_MSG(RAC_TRC_ERROR_ACTION_CONFLICT,"[RAC]ori: %Mrac_action_enum, new: %Mrac_action_enum")
TRC_MSG(RAC_TRC_ERROR_SEPARATE_DOMAIN,"[RAC]Should separate domain")
