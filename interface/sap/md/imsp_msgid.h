...
MODULE_MSG_BEGIN( MSG_ID_IMSP_CODE_BEGIN )
  ...
  MSG_ID_VDM_IMSP_RANGE_BEGIN,
    ...
    MSG_ID_VDM_IMSP_CMD_EMERG_SERV_CAT_RSP,
    ...
    MSG_ID_VDM_IMSP_CS_CC_EMERG_SERV_CAT_REQ,
    ...
    MSG_ID_VDM_IMSP_IMS_CALL_INFO_REQ,
  ...
  MSG_ID_IMSP_IMC_RANGE_BEGIN,
	...
	MSG_ID_IMSP_IMC_CALL_CONTROL_IND,
    ...
    MSG_ID_IMSP_IMC_IMS_DEREG_CNF,
    MSG_ID_IMSP_IMC_IMS_INIT_IND,
  ...
  /* LTECSR -> IMSP */
  MSG_ID_LTECSR_IMSP_RANGE_BEGIN,
    MSG_ID_LTECSR_IMSP_RTP_TIMER_EXPIRE,
    MSG_ID_LTECSR_IMSP_PKT_INFO_URC,
  MSG_ID_LTECSR_IMSP_RANGE_END,
