...
void custom_em_thermal_red_ccci_hisr_callback(kal_uint32 value)
{
    ...
    #if defined (__TAS_MAX_TXPWR_REDUCTION__)
	    l4c_l1_max_tx_pwr_red_req((kal_uint8)L4C_SRC, 1, KAL_TRUE, (kal_uint8***)gsm_tx_pwr_reduction_tbl, (kal_uint8***)gsm_tx_pwr_reduction_tbl_tas,
