...
extern void rac_sat_location_info_rsp_handler(void);
#endif
#endif
...
extern void rac_gmss_plmn_id_rat_info_ind_handler(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
#endif
