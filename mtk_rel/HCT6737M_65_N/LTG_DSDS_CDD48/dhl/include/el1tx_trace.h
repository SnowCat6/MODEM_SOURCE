...
#define Tx_CH_Str(v1)  (unsigned char)(v1+170)
#define Tx_CSI_Str(v1)  (unsigned char)(v1+174)
#define Tx_ACQI2_Hi_Str(v1)  (unsigned char)(v1+182)
#define Rx_Qual_Str(v1)  (unsigned char)(v1+187)
#define Rx_DCI_Str(v1)  (unsigned char)(v1+199)
#define UMPR_Src0_Str(v1)  (unsigned char)(v1+211)
#define UMPR_Src1_Str(v1)  (unsigned char)(v1+219)
#define TAS_Str(v1)  (unsigned char)(v1+222)
...
#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_deltaTc_PWR(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x5D07, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_deltaTc_PWR(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_RT_CMD_deltaTc_PWR_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x5D07, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))
...
void L1TRC_Send_EL1TX_LOG_RT_CMD_deltaTc_PWR(unsigned short v1, unsigned short v2, unsigned short v3, short v4, short v5);
