...
extern kal_bool l4c_nw_ims_reg_status_update_req(kal_uint8 src_id, kal_uint8 reg_state, kal_uint8 reg_type, kal_uint32 ext_info, kal_uint8 dereg_cause, kal_bool ims_retry);
