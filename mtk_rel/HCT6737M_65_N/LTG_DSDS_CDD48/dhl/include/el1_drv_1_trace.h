...
#define DRV_DSP_ACT_String(v1)  (unsigned char)(v1+123)
#define DRV_Caller_String(v1)  (unsigned char)(v1+126)
#define DRV_Presch_MId_String(v1)  (unsigned char)(v1+133)
#define DRV_Param_Type_String(v1)  (unsigned char)(v1+142)
#define DRV_Phy_Track_String(v1)  (unsigned char)(v1+161)
#define DRV_BW_String(v1)  (unsigned char)(v1+165)
#define DRV_MIB_TYPE_String(v1)  (unsigned char)(v1+173)
#define DRV_RS_String(v1)  (unsigned char)(v1+177)
#define DRV_RNTI_String0(v1)  (unsigned char)(v1+193)
#define DRV_RNTI_String1(v1)  (unsigned char)(v1+209)
#define DRV_RNTI_String2(v1)  (unsigned char)(v1+217)
#define DRV_RECAL_Str(v1)  (unsigned char)(v1+225)
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SET_RE_ERASE_EN(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7204, (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_SET_RE_ERASE_EN(v1)
#endif
#define DRV_LOG_SET_RE_ERASE_EN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7204, (char)(v1), TRC_BOXSTER_PAD))
...
void L1TRC_Send_DRV_LOG_SET_RE_ERASE_EN(char v1);
...
#define ChkL1MsgFltr_DRV_LOG_SET_RE_ERASE_EN()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace()
