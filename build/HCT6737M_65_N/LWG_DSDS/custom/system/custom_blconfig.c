 ...
 * Author:
 * -------
 *   Carlos Yeh (mtk02377)     system auto generator m0.26_MOLY + sysGenUtility m0.39 from MOLY
 *
 *============================================================================
 *             HISTORY
 ...
 *
 * 05 31 2013 cindy.tu
 *  [MT6290] Update bootloader log level
 *
 * 02 26 2013 cindy.tu
 *  MT6290 Bootloader Implementation Phase 1
 ...
 *  [Modify] Fix the case-sensitive issue on MODEM_DEV
 * .
 *
 * 05 28 2012 qmei.yang
 *  [SystemService][Auto-Gen][GCC][Internal Refinement] support AutoGen on GCC
 * Support GCC by using attribute instead of pragma
 *
...
#else  /* __TC01__ */
const LOG_LEVEL bootloader_debug_level = LOG_INFO;
#endif  /* __TC01__ */
...
__attribute__ ((zero_init, section ("EXTRAM_ZI"))) kal_uint32 g_custom_SEC_RO_buf[(sizeof(SEC_RO_ST) + SECURE_RO_SIZE_OVERHEAD)>>2];
