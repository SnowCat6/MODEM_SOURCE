...
#include "L1Trc.h"
	...
	#define EMAC_LOG_TA_MCE_IGNORE(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x020E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_SPS_UNSYNC_ERROR(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x030E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_TTI_GET_HARQ(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x050E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_REQ_DATA(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x060E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CE_PHR(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0A0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_STATUS_IND(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x0B0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DATA_REQ(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x0C0E | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DATA_REQ2(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x0D0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLOSS_SSID(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0E0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SET_TX_TL(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x100E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DUP_RETX_INFO(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x110E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_PERI_TMR_START(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x130E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_INCLUDE(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x140E | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_TRIGGER(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x150E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SET_LONG_BSR(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x170E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_RETX_INFO0(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1A0E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EAMC_LOG_DL_ASSIGNMENT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x1F0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_SWO(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x200E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_PROC_HT_RECORDS(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x210E | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_STATUS(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x230E | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_TIME_TO_HARQ(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x240E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_TIME_TO_RTT_TMR(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x260E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_HARQ_UPDATE_RNTI_TIME(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x2C0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHK_PUSCH_GRANT(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x330E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHK_PUSCH_SKIP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x360E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_SLP_NOT_TRIGGER_SR(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x3A0E | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_RCV_LEAVE_DRX(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x3B0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_LATE_WAKEUP_CNF(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x3E0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CANCEL_PENDING_HOST_DATA(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x3F0E | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_INC_GAP_RCV_END(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x450E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_INC_GAP_TMR_EXP(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x460E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_INC_ACK_IN_GAP(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x510E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_SUSPEND_DRX(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x530E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_RESERVE_GRANT(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x550E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLOSE_RESV_HARQ(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x560E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SCH_RESV_NON_ADP_RETX(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x580E | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_REQ_IN_GEMINI_GAP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x590E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_PDCCH_MAY_BE_IN_GAP(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x5A0E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_GAP_STATE(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x5B0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SET_GEMINI_PHICH(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x5E0E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_GAP_FORCE_BSR(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x5F0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_JUDGE_RETX_MODE(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x600E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_TX_SKIP_FOR_GAP(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x610E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SKIP_FOR_G_GAP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x630E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DISABLE_PHICH(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x660E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DISABLE_PHICH_BUNDLING(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x670E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_GEMINI_ALIGNED_GAP_TIME(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x680E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_GEMINI_SIM_RESULT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x690E | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_REPORT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x6A0E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_CALLOFF(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x6C0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_PREDICTION(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x6F0E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_NOT_WAKEUP(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x700E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_PREDICTION_HIT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x710E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_VSR_COVER(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x720E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_USING_VSR(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x730E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_VSR_CFG(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x740E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHECK_SR_WAKEUP(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x770E | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLOSE_INVALID_SSID(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x780E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_SAVE_MSG3_HWB(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x790E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAPID_MISMATCH_DUMP(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x7C0E | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_SET_SILENCE(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x7E0E | ((unsigned short)(v1) << 16));\
	} while(0)
#else
