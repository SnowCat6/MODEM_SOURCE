 ...
 * removed!
 * removed!
 * Add custom option __MTU_CONFIG_1568B__ to enlarge HIF DL GPD from 1536 to 1568 bytes for network issue workaround
 *
 * removed!
 * removed!
...
#ifdef __MTU_CONFIG_1568B__
// 1568 Bytes (32 Byte-Cache-Aligned)
#define QBM_HIF_DL_DATA_LEN  (1792 - QBM_HIF_DL_EXT_LEN)
#else
