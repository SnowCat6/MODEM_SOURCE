...
#ifdef __IMC_MULTIPLE_CONTEXT__
...
typedef struct {
    ...
    imcf_uint32 unsync_cfg;     /* 0:none,1:yellow_screen,2:TBD */
    imcf_uint32 imc_verno;      /* Feature set of IMC */
    imcf_uint8  MD_ver[64];     /* "MOLY.LR9.W1444.MD.LWTG.MP.V42.P71" */
    imcf_uint8  init_tlv[128];  /* Special used to carry TLV on init_ind msg */
...
// required by RTCP FB
    ...
    imcf_uint8                           text_pad[3];
    /* ======================================================================================*/

    imcf_uint8 resv[1940];
...
typedef struct {
    ...
    imcf_uint8  local_text_capability;
    imcf_uint8  remote_text_capability;
    imcf_uint8  pad[2];
...
typedef struct {
    ...
    kal_uint8               num[IMSP_IMC_SS_CONFERENCE_CONTROL_REQ_NUM_LEN];
...
/*
 * @brief
 * @note MSG_ID_IMSP_IMC_SS_ECT_IND
